...
store?.readFromFile('./furina_store.json')
// save every 10s
setInterval(() => {
	store?.writeToFile('./furina_store.json')
}, 10_000)
...
global.reloadHandler = async function (restatConn) {
  ...
  conn.welcome = '❖━━━━━━[ ᴡᴇʟᴄᴏᴍᴇ ]━━━━━━❖\n\n┏––––––━━━━━━━━•\n│☘︎ *⌜ sᴇʟᴀᴍᴀᴛ ʙᴇʀɢᴀʙᴜɴɢ ⌟*\n┣━━━━━━━━┅┅┅\n│ 👋 *ʜᴀʟʟᴏ ᴡᴇʟᴄᴏᴍᴇ* @user\n├[ *sᴇʟᴀᴍᴀᴛ ᴅᴀᴛᴀɴɢ ᴅɪ ɢʀᴏᴜᴘ* ]—\n┃「 *`@subject`* 」\n│ *sᴇᴍᴏɢᴀ ʙᴇᴛᴀʜ sᴇʟᴀʟᴜ ʏᴀ! ᴅᴀɴ ᴊᴀɴɢᴀɴ ʟᴜᴘᴀ ᴜɴᴛᴜᴋ sᴇʟᴀʟᴜ ᴍᴇᴍᴀᴛᴜʜɪ ᴘᴇʀᴀᴛᴜʀᴀɴ ɢʀᴏᴜᴘ ʏᴀɴɢ ᴀᴅᴀ😚*\n┗––––––━━┅┅┅\n\n╭───────────────♡᭄\n│       「🪷 *Кᥲr𝗍ᥙ Iᥒ𝗍r᥆* 🪷」\n│ Nᥲოᥲ      : \n│\n│ Gᥱᥒძᥱr   : \n│\n│ Uოᥙr       : \n│\n│ Н᥆ᑲᑲ𝘺     : \n│\n│ Кᥱᥣᥲ𐒖       : \n│\n│ A𐒖ᥲᥣ         : \n│\n│  Ѕ𝗍ᥲ𝗍ᥙ𐒖      : \n┗╌╌╌╌╌━━━╍┅┅┅\n\n┏╌╌╌╌╌━━━┅┅\n│ ɴᴏᴛᴇ: *📍 ᴜᴛᴀᴍᴀᴋᴀɴ ʙᴀᴄᴀ ᴅᴇsᴋʀɪᴘsɪ ʙɪᴀʀ ᴛᴀᴜ ʀᴜʟᴇs ɢʀᴏᴜᴘ ʏᴀ!!*\n┗––––––━━━┅┅'
  conn.bye = '❖━━━━━━[ ʟᴇᴀᴠɪɴɢ ]━━━━━━❖\n𝚂𝚊𝚢𝚘𝚗𝚊𝚛𝚊𝚊 @user 👋😔\n\nᴅᴏɴ`ᴛ ғᴏʀɢᴇᴛ ᴛᴏ ғᴏʟʟᴏᴡ ᴏuʀ ᴄʜᴀɴɴᴇʟ ɪɴғᴏ:\nhttps://whatsapp.com/channel/0029VadTENILdQeWx3bDTJ1d'
...
setInterval(async () => {
  ...
  let bio = `🫧 ғᴜʀɪɴᴀ ʜᴀs ʙᴇᴇɴ ᴀᴄᴛɪᴠᴇ sɪɴᴄᴇ : ${uptime}┃ 🪸 ʙᴏᴛ ʙʏ: ᴋʏᴢ`
